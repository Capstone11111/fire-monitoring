...
<ul class="nav_list">
    ...
    <li>
      ...
      <span class="link_name">MODIFY PASS</span>
      </a>
  </li>
    <li>
    ...
    while($result = mysqli_fetch_array($results)){
      ...
      <tr>
        ...
        <td><?php echo $result['code'];?></td>
          ...
          <td><a href="admindashboarddelete.php?delete=<?php echo $id; ?>"  style="color:green;"onclick="return confirm('Are you sure you want to delete this user?');">Delete</a></td>
...
<!-- -----------------------------------------------edit------------------------------------------------- -->
     ...
     <div id="myDIV" style="display:none; position:absolute; top:10%; left:40%;">
       <table align="center">
...
<tr>
  ...
  <input type="submit" name="" value="CANCEL" onclick="myFunction()">
     ...
     <!-- =============================================================== -->
     <div id="ADD" style="display:none; position:absolute; top:10%; left:40%;">
       <table align="center" >
       ...
       <tr style="color:black">
       <td >Id:</td>
       <td><input type="text" name ="a"required placeholder="Numbers only" autocomplete="off"></td>
       </tr>
